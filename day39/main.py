...
flight_data = search_flight.search_all_flight(fly_from="Budapest", fly_to="New York", date_from=f"{today.day}/{today.month}/{today.year}", date_to=f"{end_day.day}/{end_day.month}/{end_day.year}", min_night=2, max_night=7, person=1)
